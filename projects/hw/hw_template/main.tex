...
\\      \hspace{36.75pt}\Comment{guaranteed to be random.}
\end{algo}
...
\\\label{line:comment}  \hspace{36.75pt}\Comment{guaranteed to be random.}
\end{nalgo}

\Cref{line:ret} and \cref{line:comment} are both referred to using cref. You can also refer to \crefrange{line:ret}{line:comment} as a group.
