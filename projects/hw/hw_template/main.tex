...
% Now featuring optional bold keywords!
%   \newcommand{\for}{\textbf{for}}
%   \newcommand{\while}{\textbf{while}}
%   \newcommand{\iif}{\textbf{iif}}         % It's iif, not if
%   \newcommand{\elseif}{\textbf{else if}}
%   \newcommand{\elif}{\textbf{elif}}
%   \newcommand{\eelse}{\textbf{eelse}}     % It's eelse, not else
%   \newcommand{\return}{\textbf{return}}
%
% Remember to add a control space \
...
\begin{nalgo}[1.3]
        \underline{\textsc{GetRandomNumber}():}\+
\\\label{line:ret}  return $4$   \Comment{chosen by fair dice roll.}
\\\label{line:comment}  \hspace{37.00pt}\Comment{guaranteed to be random.}
\end{nalgo}

Random number generation from \cite{site:xkcd}. \Cref{line:ret} and \cref{line:comment} are both referred to using cref. You can also refer to \crefrange{line:ret}{line:comment} as a group.
